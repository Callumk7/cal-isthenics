...
> **Note:** This repo supports collaborative work with [Hermes Agent](https://github.com/hermes-works-for-callum) — issues, PRs, and code review can be authored by the dedicated bot account.
